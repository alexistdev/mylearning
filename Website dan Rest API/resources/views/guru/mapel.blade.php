            ...
            <section class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @else
                        @endif
                        <table class="table table-bordered table-striped mb-0 display nowrap" id="tabelMapel"
                               style="width: 100%">
                            <thead>
                            <tr>
            ...
            <script>
                $('#tabelMapel').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'kelas.name', class: 'text-left'},
